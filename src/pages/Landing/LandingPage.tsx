...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-yellow-50 to-green-50">
      {/* Header */}
      <header className="relative z-10 bg-white/90 backdrop-blur-sm border-b border-orange-200">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gradient-to-b from-blue-200 via-orange-100 to-green-200 relative">
            {/* Sky with subtle clouds */}
            <div className="absolute top-0 left-0 w-full h-1/3 bg-gradient-to-b from-blue-300 to-blue-100 opacity-60">
            ...
            <div className="absolute bottom-20 left-1/4 transform -translate-x-1/2">
              <div className="relative">
                {/* House 1 */}
                <div className="w-16 h-12 bg-orange-300 rounded-t-lg relative">
                  ...
                  <div className="absolute top-6 right-2 w-2 h-4 bg-yellow-800 rounded-sm"></div>
                  {/* Solar panel */}
                  <div className="absolute -top-2 right-1 w-4 h-2 bg-blue-900 rounded-sm opacity-80"></div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute bottom-16 right-1/3 transform translate-x-1/2">
              <div className="relative">
                {/* House 2 */}
                <div className="w-20 h-14 bg-yellow-300 rounded-t-lg relative">
                  <div className="absolute -top-5 left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-10 border-r-10 border-b-8 border-transparent border-b-orange-700"></div>
                  ...
                  <div className="absolute top-8 left-1/2 transform -translate-x-1/2 w-3 h-5 bg-yellow-800 rounded-sm"></div>
            ...
            <div className="absolute bottom-24 left-2/3">
              <div className="relative">
                {/* House 3 */}
                <div className="w-14 h-10 bg-red-300 rounded-t-lg relative">
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-7 border-r-7 border-b-5 border-transparent border-b-gray-700"></div>
                  <div className="absolute top-1 left-1 w-3 h-3 bg-blue-400 rounded-sm"></div>
                  <div className="absolute top-5 right-1 w-2 h-3 bg-yellow-800 rounded-sm"></div>
            ...
            <div className="absolute bottom-12 left-1/6">
              <div className="w-8 h-12 bg-yellow-800 rounded-t-full"></div>
            ...
            <div className="absolute bottom-8 right-1/5">
              <div className="w-6 h-10 bg-yellow-800 rounded-t-full"></div>
            ...
            <div className="absolute top-1/2 left-1/5">
              <Zap className="h-3 w-3 text-yellow-500 opacity-70 animate-pulse" />
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 sm:p-12 shadow-2xl border border-orange-200"
          >
            <motion.h1 
            ...
            >
              <Link
                to="/signup"
                className="group bg-gradient-to-r from-orange-600 to-red-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:from-orange-700 hover:to-red-700 transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center space-x-2"
              >
              ...
              <Link
                to="/login"
                className="border-2 border-orange-600 text-orange-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-orange-600 hover:text-white transition-all duration-300"
              >
                Demo Login
              </Link>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-orange-50 to-yellow-50 p-8 rounded-2xl border border-orange-200 hover:shadow-lg transition-all duration-300 hover:scale-105"
              >
                <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-orange-500 to-red-500 rounded-xl mb-6">
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-red-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Link
              to="/signup"
              className="inline-flex items-center space-x-2 bg-white text-orange-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-orange-50 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
