...
const Devices: React.FC = () => {
  ...
  const handleAddDevice = async (deviceData: Omit<Device, "id" | "lastSeen">) => {
    try {
      const newDevice = await apiService.addDevice(deviceData);
      setDevices([
        ...devices,
        { ...newDevice, device_name: newDevice.device_name || "Unnamed Device" },
      ]);
  ...
  const getDeviceIcon = (type: string) => {
    switch (type) {
      ...
      case "smartButton": return Smartphone;
